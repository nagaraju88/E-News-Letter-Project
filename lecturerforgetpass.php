  ...
  crossorigin="anonymous"></script>
    ...
    <?php
       if($_SERVER["REQUEST_METHOD"]=="POST")
       {
           ...
           $sql="SELECT email FROM harshini34";
          ...
          if($pas==$rpas)
           {
    $sql1="UPDATE harshini34 SET password='$rpas' WHERE email='$mail'";
                     if($con->query($sql1))
                     {
                      
                      header("Location:http://localhost/major/lecturerhome.php",true, 301);
